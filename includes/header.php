...
foreach($results as $result)
  ...
  <li><a href="index.php"><img src="assets/images/logo-header.png" alt="image"/></a></li>
    <li><a href="index.php">Home</a></li>
    <li><a href="about-us.php?type=aboutus">About Us</a></li>
    <li><a href="bicycle-list.php">Bicycle List</a></li>
    <li><a href="faqs.php?type=faqs">FAQs</a></li>
    <li><a href="contact-us.php">Contact Us</a></li>
  </ul>
  
  <?php if(strlen($_SESSION['login'])==0) { ?>
    <div class="login_btn navbar-right" style="margin-top: 20px;">
